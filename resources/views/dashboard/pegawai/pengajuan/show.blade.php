...
<div class="dashboard-wrapper">
    ...
    <div class="dashboard-content detail-single-content">
        ...
        <section class="modern-section">
            ...
            @php
                $canDeleteFromDetail = in_array($pengajuan->status->value, ['validasi_ai', 'menunggu_atasan', 'ditolak_atasan', 'ditolak_finance'], true);
            ...
            @if($canDeleteFromDetail || $isRejected)
                <div class="detail-actions-inline">
                    ...
                    @if($isRejected)
                        <a href="{{ route('pegawai.pengajuan.create') }}" class="btn-modern btn-modern-primary btn-modern-sm">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 18px; height: 18px; margin-right: 8px;">
                    ...
                    <p class="text-muted small">
                        ...
                        @else
                            Anda dapat membatalkan pengajuan selama belum masuk proses persetujuan akhir.
                        @endif
                    </p>
                </div>
            @endif
