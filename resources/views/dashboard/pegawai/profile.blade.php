...
<style>
    ...
    .p-stats-icon.approved { background: rgba(16, 185, 129, 0.1); color: #10b981; }
    .p-stats-icon.pending { background: rgba(245, 158, 11, 0.1); color: #f59e0b; }
    .p-stats-icon.total { background: rgba(66, 93, 135, 0.1); color: #425d87; }
    ...
    .budget-progress-bar.success { background: #10b981; }
    ...
    .budget-percentage-text.success { color: #10b981; }
    .budget-percentage-text.warning { color: #f59e0b; }
    .budget-percentage-text.danger { color: #ef4444; }

    .over-warning { font-weight: 800; text-decoration: underline; }
