    ...
    <div class="dashboard-container">
        ...
        <div class="tabs-container profile-tabs-container">
            ...
            <div class="modern-section profile-modern-section">
                ...
                <form action="{{ route('atasan.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    function initAtasanProfileTabs() {
        document.querySelectorAll('.tab-btn').forEach(button => {
            ...
            button.addEventListener('click', () => {
                ...
                setAtasanProfileTab(tabId);
            });
        });

        setAtasanProfileTab(initialAtasanProfileTab);
    }
