                    ...
                    <tr>
                        ...
                        <td data-label="Aksi" class="col-aksi">
                            <div class="action-buttons-centered">
                                ...
                                <a href="{{ route('atasan.pengajuan.create', ['duplicate_id' => $pengajuan->pengajuan_id]) }}" class="btn-action-icon" style="background: #f0f7ff; color: #3b82f6;" title="Ajukan lagi (Duplikat)">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                                </a>
                                @if(in_array($pengajuan->status->value, ['validasi_ai', 'menunggu_finance', 'ditolak_finance']))
                                <form action="{{ route('atasan.pengajuan.destroy', $pengajuan->pengajuan_id) }}" method="POST" style="display:inline;">
                                    @csrf @method('DELETE')
