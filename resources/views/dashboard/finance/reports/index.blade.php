    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-content reports-clean-content">
            <div class="stats-grid reports-overview">
                ...
                <div class="stat-card modern">
                    <div class="stat-left">
                        <div class="stat-value">{{ format_rupiah($totalNominal ?? 0) }}</div>
                ...
                <div class="stat-card modern">
                    <div class="stat-left">
                        <div class="stat-value">{{ number_format(count($departemen ?? [])) }}</div>
            ...
            <section class="modern-section reports-hub-section">
                ...
                <div class="reports-hub-grid">
                    <a href="{{ route('finance.report.jurnal_umum') }}" class="report-hub-card report-theme-primary">
                    ...
                    <a href="{{ route('finance.report.buku_besar') }}" class="report-hub-card report-theme-info">
                        <div class="report-hub-top">
                            <div class="report-hub-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('finance.report.laporan_arus_kas') }}" class="report-hub-card report-theme-success">
                        <div class="report-hub-top">
                            <div class="report-hub-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <line x1="12" y1="1" x2="12" y2="23"></line>
                    ...
                    <a href="{{ route('finance.report.reconciliation') }}" class="report-hub-card report-theme-teal">
                        <div class="report-hub-top">
                            <div class="report-hub-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('finance.report.budget_audit') }}" class="report-hub-card report-theme-warning">
                        <div class="report-hub-top">
                            <div class="report-hub-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
