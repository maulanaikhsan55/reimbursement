            ...
            <div class="section-header">
                ...
                <div class="header-actions">
                    <div class="export-actions" data-export-fields="search:searchInput,departemen_id:departemenInput,start_date:startDateInput,end_date:endDateInput">
                        <a href="#" onclick="exportWithFilters(event)" data-url="{{ route('finance.disbursement.history-export-csv') }}" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke CSV">
                        ...
                        <a href="#" onclick="exportWithFilters(event)" data-url="{{ route('finance.disbursement.history-export-xlsx') }}" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke XLSX">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 6px;">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                <polyline points="14 2 14 8 20 8"></polyline>
                        ...
                        <a href="#" onclick="exportWithFilters(event)" data-url="{{ route('finance.disbursement.history-export-pdf') }}" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke PDF">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 6px;">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                <polyline points="14 2 14 8 20 8"></polyline>
