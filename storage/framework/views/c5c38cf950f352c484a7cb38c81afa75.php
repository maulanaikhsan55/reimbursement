<aside class="atasan-sidebar" id="atasanSidebar" wire:persist="sidebar">
    ...
    <nav class="sidebar-menu" style="position: relative;">
        ...
        <!-- Dashboard -->
        <a href="<?php echo e(route('atasan.dashboard')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('atasan.dashboard') ? 'active' : ''); ?>">
        ...
        <!-- Pengajuan Pribadi -->
        <a href="<?php echo e(route('atasan.pengajuan.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('atasan.pengajuan.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?php echo e(route('atasan.approval.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('atasan.approval.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="badge-sidebar badge-approval-atasan" x-data="{ count: 0 }" x-init="
                const updateApprovalCount = () => {
                    fetch('<?php echo e(route('atasan.approval.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                        .then(r => r.json())
        ...
        <!-- Notifikasi -->
        <a href="<?php echo e(route('atasan.notifikasi')); ?>" wire:navigate.hover class="menu-item notifikasi-menu <?php echo e(request()->routeIs('atasan.notifikasi*') ? 'active' : ''); ?>" x-data="{
            unreadCount: 0
        }" x-init="
            const updateNotifCount = () => {
                fetch('<?php echo e(route('atasan.notifikasi.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                    .then(r => r.json())
                    .then(data => {
        ...
        <!-- Profile -->
        <a href="<?php echo e(route('atasan.profile.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('atasan.profile*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/components/atasan-sidebar.blade.php ENDPATH**/ ?>