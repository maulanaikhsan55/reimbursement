...
<script>
    ...
    function initAtasanDashboard() {
        ...
        if (statusCtx) {
            ...
            const statusData = {
                'menunggu_atasan': <?php echo e($statusData['menunggu_atasan'] ?? 0); ?>,
                'menunggu_finance': <?php echo e($statusData['menunggu_finance'] ?? 0); ?>,
                'dicairkan': <?php echo e($statusData['dicairkan'] ?? 0); ?>,
                'ditolak_atasan': <?php echo e($statusData['ditolak_atasan'] ?? 0); ?>,
                'ditolak_finance': <?php echo e($statusData['ditolak_finance'] ?? 0); ?>
            ...
            if (total === 0) {
                ...
                statusChartInstance = new Chart(statusCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo e($statusData['menunggu_atasan'] ?? 0); ?>,
                                <?php echo e($statusData['menunggu_finance'] ?? 0); ?>,
                                <?php echo e($statusData['dicairkan'] ?? 0); ?>,
                                <?php echo e(($statusData['ditolak_atasan'] ?? 0) + ($statusData['ditolak_finance'] ?? 0)); ?>
        ...
        if (categoryCtx) {
            ...
            const categoryData = <?php echo json_encode($categoryDist ?? []); ?>;
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Dashboard Atasan','subtitle' => 'Kelola dan pantau pengajuan reimbursement Anda & tim','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard Atasan','subtitle' => 'Kelola dan pantau pengajuan reimbursement Anda & tim','showNotification' => true,'showProfile' => true]); ?>
...
<?php endif; ?>
        ...
        <div class="dashboard-content">
            <div class="welcome-card" style="padding: 2.25rem 2.5rem; min-height: 180px;">
                <div class="welcome-content">
                    ...
                    <div class="welcome-text">
                        ...
                        <p class="welcome-subtitle"><?php echo e(Auth::user()->departemen->nama_departemen ?? 'Departemen'); ?></p>
                    </div>
                </div>
                <div class="welcome-stats">
                    <div class="welcome-stat-item">
                        <div class="stat-value">Rp <?php echo e(number_format($nominalPending ?? 0, 0, ',', '.')); ?></div>
                        <div class="stat-label">Sedang Diproses</div>
                    </div>
                    <div class="stat-divider"></div>
                    <div class="welcome-stat-item">
                        <div class="stat-value">Rp <?php echo e(number_format($nominalDisbursedMonth ?? 0, 0, ',', '.')); ?></div>
                        <div class="stat-label">Dicairkan (Bulan Ini)</div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($disbursedGrowth)): ?>
                            <div style="font-size: 0.7rem; font-weight: 700; color: <?php echo e($disbursedGrowth >= 0 ? '#bbf7d0' : '#fca5a5'); ?>; margin-top: 0.2rem;">
                                <?php echo $disbursedGrowth >= 0 ? '↑' : '↓'; ?> <?php echo e(abs(round($disbursedGrowth, 1))); ?>% <span style="opacity: 0.8; font-weight: 500;">vs bln lalu</span>
                            </div>
                    ...
                    <div class="welcome-stat-item" title="Total nominal pengajuan pribadi yang tidak dicairkan bulan ini (Ditolak oleh AI/Atasan/Finance)">
                        <div class="stat-value" style="color: #fca5a5;">Rp <?php echo e(number_format($nominalRejected ?? 0, 0, ',', '.')); ?></div>
                        <div class="stat-label">Proteksi Anggaran</div>
                    </div>
                </div>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeRequest ?? null): ?>
                <div class="live-status-tracker" style="background: white; border: 1px solid #f1f5f9; border-radius: 1rem; padding: 1rem; box-shadow: 0 4px 20px -5px rgba(0,0,0,0.05); margin-top: 1rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                        <h4 style="margin: 0; color: #425d87; font-weight: 800; font-size: 0.85rem; display: flex; align-items: center; gap: 0.5rem;">
                            ...
                            Live Tracker: <?php echo e($activeRequest->nomor_pengajuan); ?>
                        ...
                        <span style="font-size: 0.75rem; font-weight: 700; color: #94a3b8; background: #f8fafc; padding: 0.3rem 0.75rem; border-radius: 20px; border: 1px solid #f1f5f9;">
                            <?php echo e($activeRequest->status->label()); ?>
                    ...
                    <div class="stepper-visual" style="display: flex; justify-content: space-between; position: relative;">
                        ...
                        <div style="position: absolute; top: 14px; left: 5%; width: <?php echo e($progressWidth); ?>%; height: 3px; background: #425d87; z-index: 2; transition: width 1s cubic-bezier(0.4, 0, 0.2, 1);"></div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div style="position: relative; z-index: 3; display: flex; flex-direction: column; align-items: center; width: 60px;">
                                <div style="width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; 
                                    background: <?php echo e($isCompleted || $isActive ? '#425d87' : '#f8fafc'); ?>; 
                                    color: white; border: 3px solid <?php echo e($isActive ? '#cbd5e1' : ($isCompleted ? '#425d87' : '#f1f5f9')); ?>;
                                    ...
                                    <?php else: ?>
                                        <span style="font-size: 0.75rem; font-weight: 800; color: <?php echo e($isActive ? 'white' : '#94a3b8'); ?>"><?php echo e($index + 1); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <span style="font-size: 0.65rem; font-weight: <?php echo e($isActive ? '800' : '600'); ?>; color: <?php echo e($isActive ? '#425d87' : '#94a3b8'); ?>; margin-top: 0.6rem; text-align: center; line-height: 1.2;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($approvalQueueStats->overdue_count ?? 0) > 0): ?>
                <div class="sla-alert" style="background: white; border: 1px solid #fecaca; border-radius: 1rem; padding: 1.25rem; box-shadow: 0 4px 20px -5px rgba(239, 68, 68, 0.1); display: flex; align-items: center; gap: 1.25rem; margin-top: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0.2rem 0 0 0; color: #b91c1c; font-size: 0.8rem; opacity: 0.8;">Ada <?php echo e($approvalQueueStats->overdue_count); ?> pengajuan tim yang belum diproses lebih dari 3 hari.</p>
                    </div>
                    <a href="<?php echo e(route('atasan.pengajuan.index')); ?>" style="margin-left: auto; background: #ef4444; color: white; padding: 0.5rem 1rem; border-radius: 8px; font-size: 0.8rem; font-weight: 700; text-decoration: none; transition: all 0.2s;">Lihat Antrean</a>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="status-chart-card" style="min-height: 280px; display: flex; flex-direction: column; padding: 1rem;">
                    <div class="chart-header" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0;">
                        ...
                        <div style="display: flex; gap: 0.75rem; align-items: center;">
                            <div style="background: #f0f7ff; color: #425d87; padding: 0.6rem 1rem; border-radius: 12px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e0ebf7;">
                                Avg: Rp <?php echo e(number_format($avgDailySpending ?? 0, 0, ',', '.')); ?>
                            ...
                            <div style="background: #f0fdf4; color: #10b981; padding: 0.6rem 1rem; border-radius: 12px; font-size: 0.75rem; font-weight: 700; border: 1px solid #dcfce7;">
                                Top: <?php echo e($topCategory ?? 'Belum ada'); ?>
                    ...
                    <div style="margin-top: 0.75rem; padding-top: 0.75rem; border-top: 1px dashed #e2e8f0;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.6rem;">
                            ...
                            ?>
                            <span style="font-size: 0.8rem; font-weight: 800; color: <?php echo e($barColor); ?>;">
                                <?php echo e(number_format($usagePercent, 1)); ?>% Terpakai
                            </span>
                        </div>
                        <div style="height: 8px; background: #f1f5f9; border-radius: 10px; overflow: hidden; display: flex;">
                            <div style="width: <?php echo e(min($usagePercent, 100)); ?>%; background: <?php echo e($barColor); ?>; border-radius: 10px; transition: width 1.5s cubic-bezier(0.34, 1.56, 0.64, 1);"></div>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-top: 0.5rem;">
                            <span style="font-size: 0.7rem; color: #94a3b8; font-weight: 600;">Terpakai: Rp <?php echo e(number_format($monthlySpending ?? 0, 0, ',', '.')); ?></span>
                            <span style="font-size: 0.7rem; color: #94a3b8; font-weight: 600;">Limit: Rp <?php echo e(number_format($budgetLimit ?? 0, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="status-chart-card" style="display: flex; flex-direction: column; position: relative; padding: 1rem;">
                    ...
                    <div id="statusChartContainer" style="width: 100%; flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div style="width: 160px; height: 160px; position: relative; margin: 0.5rem 0;">
                            ...
                            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; pointer-events: none;">
                                <div style="font-size: 1.25rem; font-weight: 800; color: #425d87; line-height: 1;"><?php echo e($totalRequests ?? 0); ?></div>
                        ...
                        <div style="width: 100%; margin-top: auto; display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; padding-top: 0.75rem; border-top: 1px solid #f1f5f9;">
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.25rem;">
                                ...
                                <span style="font-size: 0.65rem; font-weight: 700; color: #425d87;"><?php echo e($statusData['menunggu_atasan'] ?? 0); ?></span>
                            </div>
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.25rem;">
                                <div style="display: flex; align-items: center; gap: 0.4rem;">
                                ...
                                <span style="font-size: 0.65rem; font-weight: 700; color: #425d87;"><?php echo e($statusData['menunggu_finance'] ?? 0); ?></span>
                            </div>
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.25rem;">
                                <div style="display: flex; align-items: center; gap: 0.4rem;">
                                ...
                                <span style="font-size: 0.65rem; font-weight: 700; color: #425d87;"><?php echo e($statusData['dicairkan'] ?? 0); ?></span>
                            </div>
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.25rem;">
                                <div style="display: flex; align-items: center; gap: 0.4rem;">
                                ...
                                <span style="font-size: 0.65rem; font-weight: 700; color: #425d87;"><?php echo e(($statusData['ditolak_atasan'] ?? 0) + ($statusData['ditolak_finance'] ?? 0)); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="categoryChartContainer" style="width: 100%; flex: 1; display: none; flex-direction: column; align-items: center; justify-content: center;">
                        ...
                        <div style="width: 100%; margin-top: auto; max-height: 80px; overflow-y: auto; padding-right: 5px; display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; padding-top: 0.5rem; border-top: 1px solid #f1f5f9;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categoryDist ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.15rem 0.25rem; border-radius: 4px; background: #f8fafc;">
                                    <div style="display: flex; align-items: center; gap: 0.35rem; min-width: 0;">
                                        <div style="width: 6px; height: 6px; border-radius: 50%; background: <?php echo e(['#425d87', '#6366f1', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899'][$index % 7]); ?>; flex-shrink: 0;"></div>
                                        <span style="font-size: 0.6rem; font-weight: 600; color: #64748b; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($catName); ?></span>
                                    </div>
                                    <span style="font-size: 0.6rem; font-weight: 700; color: #425d87; flex-shrink: 0;"><?php echo e(number_format($catTotal / 1000, 0)); ?>k</span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-top: 1rem;">
                <div class="team-overview-card" style="background: white; border-radius: 1.25rem; border: 1px solid #f1f5f9; padding: 1rem; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05);">
                    <div style="margin-bottom: 0.75rem; padding-bottom: 0.5rem; border-bottom: 1px solid #f1f5f9;">
                        ...
                        <p style="font-size: 0.75rem; color: #64748b; margin: 0.2rem 0 0 0;"><?php echo e($teamMembers->count()); ?> anggota tim</p>
                    </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="display: grid; grid-template-columns: 1fr 80px 80px 80px; gap: 0.5rem; padding: 0.6rem; background: #f8fafc; border-radius: 8px; align-items: center; font-size: 0.75rem;">
                                    <div style="min-width: 0;">
                                        <div style="font-weight: 600; color: #1e293b; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($member->name); ?></div>
                                        <div style="color: #94a3b8; font-size: 0.7rem;"><?php echo e($member->total_count); ?> pengajuan</div>
                                    </div>
                                    <div style="text-align: right;">
                                        <div style="font-weight: 700; color: #425d87;"><?php echo e($member->pending_nominal > 0 ? 'Rp ' . number_format($member->pending_nominal / 1000, 0) . 'k' : '-'); ?></div>
                                        <div style="color: #94a3b8; font-size: 0.65rem;">Proses</div>
                                    </div>
                                    <div style="text-align: right;">
                                        <div style="font-weight: 700; color: #10b981;"><?php echo e($member->approved_nominal > 0 ? 'Rp ' . number_format($member->approved_nominal / 1000, 0) . 'k' : '-'); ?></div>
                                        <div style="color: #94a3b8; font-size: 0.65rem;">Cair</div>
                                    </div>
                                    <div style="text-align: right;">
                                        <div style="font-weight: 700; color: #64748b;"><?php echo e($member->total_count); ?></div>
                ...
                <div class="approval-queue-card" style="background: white; border-radius: 1.25rem; border: 1px solid #f1f5f9; padding: 1rem; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05);">
                    <div style="margin-bottom: 1rem;">
                        ...
                        <p style="font-size: 0.75rem; color: #64748b; margin: 0;"><?php echo e($approvalQueueStats->total_count ?? 0); ?> item menunggu</p>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                        <div style="background: #f8fafc; padding: 0.75rem; border-radius: 8px; text-align: center; border: 1px solid #e2e8f0;">
                            ...
                            <div style="font-size: 1.5rem; font-weight: 800; color: #425d87;"><?php echo e($approvalQueueStats->new_count ?? 0); ?></div>
                        </div>
                        <div class="sla-card <?php echo e(($approvalQueueStats->overdue_count ?? 0) > 0 ? 'sla-alert' : ''); ?>" style="background: #f8fafc; padding: 0.75rem; border-radius: 8px; text-align: center; border: 1px solid #e2e8f0; transition: all 0.3s ease;">
                            <div style="font-size: 0.8rem; color: #64748b; font-weight: 600; margin-bottom: 0.4rem;">Tertunda</div>
                            <div style="font-size: 1.5rem; font-weight: 800; color: <?php echo e(($approvalQueueStats->overdue_count ?? 0) > 0 ? '#ef4444' : '#10b981'); ?>;"><?php echo e($approvalQueueStats->overdue_count ?? 0); ?></div>
                        </div>
                    </div>

                    <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #f1f5f9;">
                        <div style="font-size: 0.75rem; color: #64748b; font-weight: 600; margin-bottom: 0.4rem;">Total Nominal</div>
                        <div style="font-size: 1rem; font-weight: 800; color: #425d87;">Rp <?php echo e(number_format($approvalQueueStats->total_nominal ?? 0, 0, ',', '.')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-main-grid" style="display: grid; grid-template-columns: 1fr 300px; gap: 1rem; align-items: start; margin-top: 1rem;">
                ...
                <div class="recent-section" style="background: white; border-radius: 1.25rem; border: 1px solid #f1f5f9; padding: 1rem; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; padding-bottom: 0.5rem; border-bottom: 1px solid #f1f5f9;">
                        ...
                        <a href="<?php echo e(route('atasan.pengajuan.index')); ?>" style="font-size: 0.75rem; color: #3b82f6; text-decoration: none; font-weight: 700; display: flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: #eff6ff; border-radius: 8px; transition: all 0.2s;">
                            Lihat Semua
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td data-label="No. Pengajuan" style="padding: 0.6rem 0.5rem;">
                                                <span style="font-weight: 700; color: #334155;"><?php echo e($pengajuan->nomor_pengajuan); ?></span>
                                            </td>
                                            <td data-label="Pemohon" style="padding: 0.6rem 0.5rem;">
                                                <span style="font-weight: 600; color: #1e293b;"><?php echo e($pengajuan->user->name); ?></span>
                                            </td>
                                            ...
                                            <td data-label="Nominal" style="padding: 0.6rem 0.5rem;">
                                                <span style="font-weight: 700; color: #1e293b;"><?php echo e(format_rupiah($pengajuan->nominal)); ?></span>
                                            </td>
                                            ...
                                            <td data-label="Aksi" style="text-align: center; padding: 0.6rem 0.5rem;">
                                                <a href="<?php echo e(route('atasan.pengajuan.show', $pengajuan->pengajuan_id)); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600; font-size: 0.8rem;">Lihat</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </tbody>
                ...
                <div class="quick-actions-minimal">
                    ...
                    <div class="quick-actions-vertical">
                        <a href="<?php echo e(route('atasan.pengajuan.create')); ?>" class="modern-action-card quick-card quick-card-primary">
                        ...
                        <a href="<?php echo e(route('atasan.pengajuan.index')); ?>" class="modern-action-card quick-card quick-card-warning">
                        ...
                        <a href="<?php echo e(route('atasan.profile.index')); ?>" class="modern-action-card quick-card quick-card-success">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/atasan/dashboard.blade.php ENDPATH**/ ?>