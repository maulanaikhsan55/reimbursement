<?php $__env->startSection('title', 'Dashboard Finance - Pusat Kontrol Keuangan'); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/finance-dashboard.css')); ?>">
<style>
    @keyframes pulse-red {
...
<script>
    (function() {
        window.financeChartData = {
            activity: <?php echo json_encode($dailyTrend ?? [], 15, 512) ?>,
            distribution: <?php echo json_encode($departementDistribution ?? [], 15, 512) ?>,
            status: <?php echo json_encode($statusDistribution ?? [], 15, 512) ?>,
            category: <?php echo json_encode($categoryDistribution ?? [], 15, 512) ?>,
            monthly: <?php echo json_encode($monthlyTrend ?? [], 15, 512) ?>
        };
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Dashboard Finance','subtitle' => 'Pusat Kontrol Keuangan Reimbursement','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard Finance','subtitle' => 'Pusat Kontrol Keuangan Reimbursement','showNotification' => true,'showProfile' => true]); ?>
        ...
        <div class="dashboard-content">
            ...
            <div class="finance-kpi-grid" data-focus="essential">
                <div class="stat-card modern dashboard-card" style="animation-delay: 0.04s;">
                    <div class="stat-left">
                        ...
                        <div class="stat-value"><?php echo e(number_format($waiting_finance_count ?? 0)); ?></div>
                ...
                <div class="stat-card modern dashboard-card" style="animation-delay: 0.08s;">
                    <div class="stat-left">
                        ...
                        <div class="stat-value"><?php echo e(number_format($oversla_count ?? 0)); ?></div>
                        <span class="stat-note"><?php echo e(number_format($financeAlerts)); ?> total alert proses</span>
                    </div>
                ...
                <div class="stat-card modern dashboard-card" style="animation-delay: 0.12s;">
                    <div class="stat-left">
                        ...
                        <div class="stat-value currency"><?php echo e(format_rupiah($this_month_disbursed ?? 0)); ?></div>
                ...
                <div class="stat-card modern dashboard-card" style="animation-delay: 0.16s;">
                    <div class="stat-left">
                        ...
                        <div class="stat-value currency"><?php echo e(format_rupiah($remainingBudget)); ?></div>
                        <span class="stat-note"><?php echo e(number_format(min($budgetUsage, 100), 1)); ?>% budget terpakai</span>
                    </div>
            ...
            <div class="top-overview-grid" data-focus="essential">
                ...
                <div class="welcome-card dashboard-card" style="animation-delay: 0.1s;">
                    <div class="welcome-content">
                        <div class="welcome-avatar">
                            <span class="avatar-initial"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                        </div>
                        <div class="welcome-text">
                            <h2 class="welcome-title">Halo, <?php echo e(explode(' ', Auth::user()->name)[0]); ?>!</h2>
                            ...
                            <div style="margin-top: 1rem; display: flex; gap: 1.5rem;">
                                <div class="mini-stat">
                                    ...
                                    <span class="value"><?php echo e($total_pending_count ?? 0); ?></span>
                                </div>
                                <div class="stat-divider"></div>
                                <div class="mini-stat">
                                    <span class="label">Pengajuan Baru</span>
                                    <span class="value"><?php echo e($requests_today ?? 0); ?></span>
                                </div>
                                <div class="stat-divider"></div>
                                <div class="mini-stat">
                                    <span class="label">SLA Alert</span>
                                    <span class="value" style="color: <?php echo e($oversla_count > 0 ? '#fca5a5' : '#bbf7d0'); ?>"><?php echo e($oversla_count ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="budget-card dashboard-card" style="animation-delay: 0.2s;">
                    ...
                    <div class="card-balance">
                        ...
                        <h3 class="balance-amount"><?php echo e(format_rupiah($this_month_processed_amount ?? 0)); ?></h3>
                    </div>
                    <div class="card-footer">
                        <div class="card-holder">
                            <span class="holder-label">Limit Anggaran Perusahaan</span>
                            <span class="holder-name">Rp <?php echo e(number_format($monthly_budget ?? 0, 0, ',', '.')); ?></span>
                        </div>
                        <div class="card-logo">
            ...
            <div class="priority-actions dashboard-card" style="animation-delay: 0.25s;" data-focus="essential">
                ...
                <div class="priority-actions-grid">
                    <a href="<?php echo e(route('finance.approval.index')); ?>" class="priority-action-item">
                        ...
                        <span class="priority-action-content">
                            ...
                            <small><?php echo e($total_pending_count ?? 0); ?> menunggu verifikasi</small>
                        </span>
                    </a>
                    <a href="<?php echo e(route('finance.disbursement.index')); ?>" class="priority-action-item">
                    ...
                    <a href="<?php echo e(route('finance.report.index')); ?>" class="priority-action-item">
                    ...
                    <a href="<?php echo e(route('finance.masterdata.users.index')); ?>" class="priority-action-item">
                        ...
                        <div class="chart-container compact-chart compact-center">
                            <div class="donut-wrapper">
                                ...
                                <div class="donut-center">
                                    <div class="donut-count"><?php echo e(count($departementDistribution ?? [])); ?></div>
            ...
            <div class="stats-grid dashboard-card" style="animation-delay: 0.5s;" data-focus="support">
                <div class="stat-card modern">
                    <div class="stat-left">
                        ...
                        <div class="stat-value"><?php echo e($totalUsers ?? 0); ?> <span style="font-size: 0.8rem; color: #94a3b8; font-weight: 500;">User Aktif</span></div>
                    </div>
                    <div class="stat-icon primary-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                ...
                <div class="stat-card modern">
                    <div class="stat-left">
                        ...
                        <div class="stat-value"><?php echo e($totalDepartemen ?? 0); ?> <span style="font-size: 0.8rem; color: #94a3b8; font-weight: 500;">Unit Kerja</span></div>
                    </div>
                ...
                <div class="stat-card modern">
                    <div class="stat-left">
                        ...
                        <div class="stat-value"><?php echo e($totalCategories ?? 0); ?> <span style="font-size: 0.8rem; color: #94a3b8; font-weight: 500;">COA Terpetakan</span></div>
                    </div>
                    <div class="stat-icon success-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="info-card dashboard-card" style="animation-delay: 0.4s;">
                    <div class="info-header">
                        <div>
                            ...
                            <div class="info-main-value"><?php echo e(format_rupiah($this_month_amount ?? 0)); ?></div>
                        </div>
                    ...
                    <div class="info-target-section">
                        <div class="target-label">
                            ...
                            <span><?php echo e(round(($budget_usage_percent ?? 0), 1)); ?>%</span>
                        </div>
                        <div class="progress-track">
                            <div class="progress-fill" style="width: <?php echo e(min(($budget_usage_percent ?? 0), 100)); ?>%; background: #3b82f6;"></div>
                        </div>
                    </div>
                    ...
                    <div class="info-footer">
                        <div class="footer-stat">
                            ...
                            <span class="footer-value"><?php echo e(format_rupiah($avg_request_amount ?? 0)); ?></span>
                        </div>
                        <div class="footer-stat" style="align-items: flex-end;">
                            <span class="footer-label">Frekuensi</span>
                            <span class="footer-value"><?php echo e($this_month_count ?? 0); ?>x</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-card dashboard-card" style="animation-delay: 0.5s;">
                    <div class="info-header">
                        <div>
                            ...
                            <div class="info-main-value"><?php echo e(format_rupiah($this_month_disbursed ?? 0)); ?></div>
                        </div>
                    ...
                    <div class="info-target-section">
                        <div class="trend-indicator <?php echo e(($growth_percentage ?? 0) >= 0 ? 'trend-up' : 'trend-down'); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($growth_percentage ?? 0) >= 0): ?>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16">
                                    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                                    <polyline points="17 6 23 6 23 12"></polyline>
                                </svg>
                                +<?php echo e(round(($growth_percentage ?? 0), 1)); ?>%
                            <?php else: ?>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16">
                    ...
                    <div class="info-footer">
                        <div class="footer-stat">
                            ...
                            <span class="footer-value"><?php echo e(format_rupiah($lifetime_disbursed ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-card dashboard-card" style="animation-delay: 0.6s;">
                    <div class="info-header">
                        <div>
                            ...
                            <div class="info-main-value"><?php echo e($waiting_finance_count ?? 0); ?></div>
                        </div>
                    ...
                    <div class="info-target-section">
                         <div class="target-label">
                            ...
                            <span><?php echo e(format_rupiah($waiting_finance_amount ?? 0)); ?></span>
                        </div>
                        <div class="progress-track">
                            <?php 
                            ...
                            ?>
                            <div class="progress-fill" style="width: <?php echo e($visualPercent); ?>%; background: #f59e0b;"></div>
                        </div>
                    </div>
                    ...
                    <div class="info-footer">
                        <div class="footer-stat">
                            ...
                            <span class="footer-value"><?php echo e(format_rupiah($waiting_atasan_amount ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- ===== SLA ALERT ===== -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($oversla_count ?? 0) > 0): ?>
            <div class="modern-section sla-alert dashboard-card" style="margin-bottom: 0; animation-delay: 0.7s;">
                <div style="display: flex; align-items: start; gap: 1rem;">
                    ...
                    <div style="flex: 1;">
                        <h2 style="margin: 0 0 0.5rem 0; color: #991b1b; font-size: 1.1rem; font-weight: 800;">
                            Perhatian: <?php echo e($oversla_count); ?> Pengajuan Melebihi SLA (<?php echo e($slaDays ?? 3); ?> Hari)
                        </h2>
                        <p style="margin: 0; color: #b91c1c; font-size: 0.9rem; opacity: 0.85;">
                            Tindakan segera diperlukan. Pengajuan yang overdue terkumpul dengan nominal tertahan <?php echo e(format_rupiah($oversla_nominal ?? 0)); ?>.
                        </p>
                    </div>
                    <a href="<?php echo e(route('finance.approval.index', ['sla_overdue' => 1])); ?>" style="background: #ef4444; color: white; padding: 0.75rem 1.5rem; border-radius: 0.875rem; font-size: 0.875rem; font-weight: 700; text-decoration: none; transition: all 0.2s; align-self: center; white-space: nowrap;">
                        Lihat Detail SLA
                    </a>
                </div>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-top: 1.5rem;">
                    <div class="stat-card modern" style="box-shadow: none; border: 1px solid #fee2e2; background: white; min-height: 90px; padding: 1rem;">
                        <div class="stat-left">
                            <div class="stat-value" style="color: #dc2626; font-size: 1.5rem;"><?php echo e($oversla_count ?? 0); ?></div>
                            <div class="stat-label">Total Outstanding</div>
                        </div>
                    </div>
                    <div class="stat-card modern" style="box-shadow: none; border: 1px solid #fee2e2; background: white; min-height: 90px; padding: 1rem;">
                        <div class="stat-left">
                            <div class="stat-value" style="color: #dc2626; font-size: 1.5rem;"><?php echo e(format_rupiah($oversla_nominal ?? 0)); ?></div>
                            <div class="stat-label">Nominal Tertahan</div>
                        </div>
                    </div>
                    <div class="stat-card modern" style="box-shadow: none; border: 1px solid #fee2e2; background: white; min-height: 90px; padding: 1rem;">
                        <div class="stat-left">
                            <div class="stat-value" style="color: #dc2626; font-size: 1.5rem;"><?php echo e(round(($oversla_avg_days ?? 0), 1)); ?> Hari</div>
            ...
            <div class="finance-grid-3-2" data-focus="risk">
                ...
                <section class="modern-section dashboard-card compact-insight-card" style="animation-delay: 0.6s;">
                    ...
                    <div class="data-table-wrapper">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pendingByCategory ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="pending-row" data-category="<?php echo e(strtolower($item?->nama_kategori ?? '')); ?>">
                                    ...
                                    <td style="text-align: center;">
                                        <span class="badge-status-menunggu_verifikasi"><?php echo e($item?->count ?? 0); ?></span>
                                    </td>
                                    <td style="font-weight: 700; color: #475569;"><?php echo e(format_rupiah($item?->total_nominal ?? 0)); ?></td>
                                    <td>
                ...
                <section class="modern-section dashboard-card compact-insight-card" style="animation-delay: 0.7s;">
                    ...
                    <div class="rejection-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rejectionRateByCategory ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="rejection-item" data-category="<?php echo e(strtolower($rate?->nama_kategori ?? '')); ?>">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem; align-items: center;">
                                <span style="font-size: 0.8rem; font-weight: 700; color: #64748b;"><?php echo e($rate?->nama_kategori ?? '-'); ?></span>
                                <span style="font-size: 0.8rem; font-weight: 800; color: <?php echo e(($rate?->rejection_rate ?? 0) > 20 ? '#ef4444' : '#64748b'); ?>;">
                                    <?php echo e(round($rate?->rejection_rate ?? 0, 1)); ?>%
                                </span>
                            </div>
                            <div style="margin-bottom: 0.35rem;">
                                <div class="progress-track" style="height: 8px;">
                                    <div class="progress-fill" style="width: <?php echo e($rate?->rejection_rate ?? 0); ?>%; background: <?php echo e(($rate?->rejection_rate ?? 0) > 20 ? '#ef4444' : '#94a3b8'); ?>;"></div>
                                </div>
                            </div>
                            <div style="display: flex; justify-content: space-between; font-size: 0.7rem; color: #94a3b8;">
                                <span><?php echo e($rate?->approved_count ?? 0); ?> disetujui</span>
                                <span><?php echo e($rate?->rejected_count ?? 0); ?> ditolak</span>
                            </div>
                        </div>
            ...
            <div class="finance-grid-2-1 align-start compact-workspace ops-split-grid" data-focus="ops">
                ...
                <section class="modern-section dashboard-card activity-compact-card" style="animation-delay: 0.8s;">
                    <div class="section-header">
                        ...
                        <a href="<?php echo e(route('finance.approval.index')); ?>" class="btn-text">Lihat Semua &rarr;</a>
                    </div>
                    <div class="data-table-wrapper">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentRequests->isEmpty()): ?>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $recentDate = $pengajuan->tanggal ?? $pengajuan->created_at ?? null;
                                ?>
                                <tr class="recent-row" data-date="<?php echo e($recentDate ? \Illuminate\Support\Carbon::parse($recentDate)->format('Y-m-d') : ''); ?>">
                                    <td>
                                        <div style="font-weight: 600; color: #1e293b;"><?php echo e($pengajuan->user->name ?? '-'); ?></div>
                                        <div style="font-size: 0.75rem; color: #64748b;"><?php echo e($pengajuan->departemen->nama_departemen ?? '-'); ?></div>
                                    </td>
                                    <td style="font-weight: 700; color: #1e293b;"><?php echo e(format_rupiah($pengajuan->nominal ?? 0)); ?></td>
                                    <td>
                                        <span style="font-size: 0.75rem; font-weight: 600; color: #425d87; background: #e8ecf8; padding: 0.25rem 0.5rem; border-radius: 6px;">
                                            <?php echo e($pengajuan->kategori->nama_kategori ?? '-'); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge-status-<?php echo e($pengajuan->status->value ?? ''); ?>">
                                            <?php echo e($pengajuan->status->label() ?? '-'); ?>

                                        </span>
                                    </td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo e(route('finance.approval.show', $pengajuan)); ?>" style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: #f8fafc; border: 1.5px solid #e5eaf2; border-radius: 8px; color: #64748b; text-decoration: none; transition: all 0.2s;">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16">
                ...
                <section class="widget-card dashboard-card smart-rail-widget ops-top-requesters" style="animation-delay: 0.84s;">
                    ...
                    <div class="top-requesters-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topRequesters ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="requester-item">
                            <div class="requester-avatar">
                                <span><?php echo e(substr($requester?->name ?? '', 0, 1)); ?></span>
                            </div>
                            <div class="requester-info">
                                <span class="requester-name"><?php echo e($requester?->name ?? '-'); ?></span>
                                <span class="requester-requests"><?php echo e($requester?->total_requests ?? 0); ?> Pengajuan</span>
                            </div>
                            <div class="requester-amount"><?php echo e(format_rupiah($requester?->total_nominal ?? 0)); ?></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/finance/dashboard.blade.php ENDPATH**/ ?>