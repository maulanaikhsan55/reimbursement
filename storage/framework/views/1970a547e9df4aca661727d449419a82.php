...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Humplus Reimbursement'); ?></title>
...
?>
<body class="<?php echo e($roleBodyClass); ?>">
    ...
    <div class="wrapper">
        <div class="mobile-header">
            ...
            <div class="mobile-logo">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="height: 30px;">
            </div>
        ...
        <div id="sidebar-wrapper">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('finance.*')): ?>
                <?php if (isset($component)) { $__componentOriginalbf67a72e97a6d918303793209290985a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbf67a72e97a6d918303793209290985a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.finance-sidebar','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('finance-sidebar'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalbf67a72e97a6d918303793209290985a)): ?>
<?php $attributes = $__attributesOriginalbf67a72e97a6d918303793209290985a; ?>
<?php unset($__attributesOriginalbf67a72e97a6d918303793209290985a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbf67a72e97a6d918303793209290985a)): ?>
<?php $component = $__componentOriginalbf67a72e97a6d918303793209290985a; ?>
<?php unset($__componentOriginalbf67a72e97a6d918303793209290985a); ?>
<?php endif; ?>
            <?php elseif(request()->routeIs('pegawai.*')): ?>
                <?php if (isset($component)) { $__componentOriginal78f542cf40048df44a89032756041ebf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f542cf40048df44a89032756041ebf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pegawai-sidebar','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pegawai-sidebar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal78f542cf40048df44a89032756041ebf)): ?>
<?php $attributes = $__attributesOriginal78f542cf40048df44a89032756041ebf; ?>
<?php unset($__attributesOriginal78f542cf40048df44a89032756041ebf); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal78f542cf40048df44a89032756041ebf)): ?>
<?php $component = $__componentOriginal78f542cf40048df44a89032756041ebf; ?>
<?php unset($__componentOriginal78f542cf40048df44a89032756041ebf); ?>
<?php endif; ?>
            <?php elseif(request()->routeIs('atasan.*')): ?>
                <?php if (isset($component)) { $__componentOriginale817fbf74d2e5fd2914a9214b0bea4ee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale817fbf74d2e5fd2914a9214b0bea4ee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.atasan-sidebar','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('atasan-sidebar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale817fbf74d2e5fd2914a9214b0bea4ee)): ?>
<?php $attributes = $__attributesOriginale817fbf74d2e5fd2914a9214b0bea4ee; ?>
<?php unset($__attributesOriginale817fbf74d2e5fd2914a9214b0bea4ee); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale817fbf74d2e5fd2914a9214b0bea4ee)): ?>
<?php $component = $__componentOriginale817fbf74d2e5fd2914a9214b0bea4ee; ?>
<?php unset($__componentOriginale817fbf74d2e5fd2914a9214b0bea4ee); ?>
<?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        
        <div class="main-content <?php echo e((request()->is('finance*') || request()->is('pegawai*') || request()->is('atasan*')) ? 'main-content-shifted' : ''); ?>" style="position: relative; min-height: 100vh;">
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success') || session('error') || session('warning') || session('info') || $errors->any()): ?>
    <script>
        (function() {
            const initNotifications = () => {
                ...
                <?php if(session('success')): ?>
                    window.showNotification('success', 'Berhasil', "<?php echo addslashes(session('success')); ?>");
                <?php endif; ?>

                <?php if(session('error')): ?>
                    window.showNotification('error', 'Terjadi Kesalahan', "<?php echo addslashes(session('error')); ?>");
                <?php endif; ?>

                <?php if(session('warning')): ?>
                    window.showNotification('warning', 'Peringatan', "<?php echo addslashes(session('warning')); ?>");
                <?php endif; ?>

                <?php if(session('info')): ?>
                    window.showNotification('info', 'Informasi', "<?php echo addslashes(session('info')); ?>");
                <?php endif; ?>

                <?php if($errors->any()): ?>
                    let errorHtml = '<ul style="margin: 5px 0 0; padding-left: 15px; text-align: left;">';
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        errorHtml += '<li><?php echo addslashes($error); ?></li>';
    ...
    <?php if(request()->routeIs('*.pengajuan.create')): ?>
    ...
    <script data-navigate-once>
        const notifUserRole = <?php echo \Illuminate\Support\Js::from(Auth::user()->role ?? null)->toHtml() ?>;
        const notifRouteMap = {
            pegawai: {
                detailBase: <?php echo \Illuminate\Support\Js::from(url('/pegawai/pengajuan'))->toHtml() ?>,
                notif: <?php echo \Illuminate\Support\Js::from(route('pegawai.notifikasi'))->toHtml() ?>,
                markReadBase: <?php echo \Illuminate\Support\Js::from(url('/pegawai/notifikasi'))->toHtml() ?>,
            },
            atasan: {
                detailBase: <?php echo \Illuminate\Support\Js::from(url('/atasan/approval'))->toHtml() ?>,
                notif: <?php echo \Illuminate\Support\Js::from(route('atasan.notifikasi'))->toHtml() ?>,
                markReadBase: <?php echo \Illuminate\Support\Js::from(url('/atasan/notifikasi'))->toHtml() ?>,
            },
            finance: {
                detailBase: <?php echo \Illuminate\Support\Js::from(url('/finance/approval'))->toHtml() ?>,
                notif: <?php echo \Illuminate\Support\Js::from(route('finance.notifikasi'))->toHtml() ?>,
                markReadBase: <?php echo \Illuminate\Support\Js::from(url('/finance/notifikasi'))->toHtml() ?>,
            },
        };
        ...
        const initEchoListener = () => {
            if (window.Echo) {
                const channelName = 'App.Models.User.<?php echo e(Auth::id()); ?>';
...
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/layouts/app.blade.php ENDPATH**/ ?>