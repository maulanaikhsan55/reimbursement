...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Kelola Pengguna','subtitle' => 'Tambah, edit, atau hapus pengguna sistem','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kelola Pengguna','subtitle' => 'Tambah, edit, atau hapus pengguna sistem','showNotification' => true,'showProfile' => true]); ?>
...
<?php endif; ?>
        ...
        <div class="dashboard-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card modern">
                    <div class="stat-left">
                        <div class="stat-value"><?php echo e($stats['nonaktif']); ?></div>
            ...
            <section class="modern-section">
                <div class="section-header">
                    ...
                    <div class="header-actions">
                        <a href="<?php echo e(route('finance.masterdata.users.create')); ?>" class="btn-modern btn-modern-primary">
                ...
                <div class="filter-container">
                    <form id="filterForm" action="<?php echo e(route('finance.masterdata.users.index')); ?>" method="GET" class="filter-form-finance">
                        <!-- Search -->
                        <div class="filter-group-pegawai">
                            ...
                            <div class="search-group">
                                ...
                                <input type="text" name="search" id="searchInput" value="<?php echo e(request('search')); ?>" class="filter-input-pegawai search-input" placeholder="Nama atau email..." autocomplete="search">
                            </div>
                        </div>
                        ...
                        <div class="filter-actions-pegawai">
                            ...
                            <a href="<?php echo e(route('finance.masterdata.users.index')); ?>" class="btn-reset-pegawai" title="Reset Filter">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td data-label="Nama Lengkap" class="col-nama">
                                                <div style="font-weight: 700; color: #1e293b; font-size: 0.95rem;"><?php echo e($user->name); ?></div>
                                                <div style="font-size: 0.75rem; color: #64748b; margin-top: 2px;"><?php echo e($user->jabatan); ?></div>
                                            </td>
                                            <td data-label="Kontak" class="col-kontak">
                                                <div class="email-text" style="margin-bottom: 4px;"><?php echo e($user->email); ?></div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->nomor_telepon): ?>
                                            ...
                                            <td data-label="Departemen" class="col-dept">
                                                <div style="font-weight: 500; color: #475569;"><?php echo e($user->departemen->nama_departemen ?? '-'); ?></div>
                                            </td>
                                            <td data-label="Rekening" class="col-rekening">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->nama_bank || $user->nomor_rekening): ?>
                                                    <div style="font-weight: 600; color: #1e293b; font-size: 0.85rem;"><?php echo e($user->nama_bank ?? 'Bank -'); ?></div>
                                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.75rem; color: #64748b;"><?php echo e($user->nomor_rekening ?? '-'); ?></div>
                                                <?php else: ?>
                                            ...
                                            <td data-label="Aksi" class="col-aksi">
                                                <div class="action-buttons-centered">
                                                    <a href="<?php echo e(route('finance.masterdata.users.edit', $user->id)); ?>" class="btn-action-icon" title="Edit">
                                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                        </svg>
                                                    </a>
                                                    <button type="button" class="btn-action-icon" onclick="confirmResetPassword('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')" title="Reset Password" style="color: #f59e0b;">
                                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->id !== auth()->id()): ?>
                                                        <button type="button" class="btn-action-icon btn-action-delete" onclick="confirmDeleteUser('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')" title="Hapus">
                                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/finance/masterdata/users/index.blade.php ENDPATH**/ ?>