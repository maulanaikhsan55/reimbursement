<aside class="pegawai-sidebar" wire:persist="sidebar">
    ...
    <nav class="sidebar-menu" style="position: relative;">
        ...
        <!-- Dashboard -->
        <a href="<?php echo e(route('pegawai.dashboard')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('pegawai.dashboard') ? 'active' : ''); ?>">
        ...
        <!-- Pengajuan -->
        <a href="<?php echo e(route('pegawai.pengajuan.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('pegawai.pengajuan.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?php echo e(route('pegawai.notifikasi')); ?>" wire:navigate.hover class="menu-item notifikasi-menu <?php echo e(request()->routeIs('pegawai.notifikasi*') ? 'active' : ''); ?>" x-data="{
            unreadCount: 0
        }" x-init="
            const updateNotifCount = () => {
                fetch('<?php echo e(route('pegawai.notifikasi.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                    .then(r => r.json())
                    .then(data => {
        ...
        <!-- Profile -->
        <a href="<?php echo e(route('pegawai.profile.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('pegawai.profile.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/components/pegawai-sidebar.blade.php ENDPATH**/ ?>