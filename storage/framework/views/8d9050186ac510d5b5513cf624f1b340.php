...
<div class="notification-bell-wrapper" x-data="{
    ...
    unreadCount: <?php echo e((int) $unreadCount); ?>,
    autoCloseTimer: null,
    clearAutoCloseTimer() {
    ...
    <button type="button" @click="open = !open; if (!open) clearAutoCloseTimer();" class="notification-bell-btn" title="Notifikasi">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadCount > 0): ?>
            <span class="notification-badge <?php echo e($unreadCount > 0 ? 'badge-bounce' : ''); ?>">
    ...
    <div x-show="open"
        ...
        <div class="notification-header">
            <div class="notification-title">
                <h4>Notifikasi</h4>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadCount > 0): ?>
                    <span class="unread-badge"><?php echo e($unreadCount); ?> Baru</span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        ...
        <div class="notification-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div wire:click="markAsRead('<?php echo e($item->notifikasi_id); ?>')" 
                     class="notification-item <?php echo e(!$item->is_read ? 'unread' : ''); ?>">
                    ...
                    <div class="notification-content">
                        <div class="notification-text">
                            <p class="notif-title"><?php echo e($item->judul); ?></p>
                            <p class="notif-message"><?php echo e($item->pesan); ?></p>
        ...
        <div class="notification-footer">
            <a href="<?php echo e(route(auth()->user()->role . '.notifikasi')); ?>" class="view-all-btn">
                Lihat Semua Notifikasi
            </a>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/livewire/notification-bell.blade.php ENDPATH**/ ?>