...
<?php endif; ?>
        ...
        <div id="statsContainer">
            <?php echo $__env->make('dashboard.pegawai.pengajuan.partials._stats', ['stats' => $stats], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <section class="modern-section pengajuan-index-shell">
            <div class="section-header">
                ...
                <div class="header-actions">
                    <div class="export-actions">
                        <a href="#" onclick="exportCsv(event)" data-url="<?php echo e(route('pegawai.pengajuan.export-csv')); ?>" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke CSV">
                        ...
                        <a href="#" onclick="exportXlsx(event)" data-url="<?php echo e(route('pegawai.pengajuan.export-xlsx')); ?>" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke XLSX">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 6px;">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                <polyline points="14 2 14 8 20 8"></polyline>
                        ...
                        <a href="#" onclick="exportPdf(event)" data-url="<?php echo e(route('pegawai.pengajuan.export-pdf')); ?>" class="btn-modern btn-modern-secondary btn-modern-sm no-loader" title="Export ke PDF">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 6px;">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                <polyline points="14 2 14 8 20 8"></polyline>
            ...
            <div class="filter-container">
                <form id="filterForm" action="<?php echo e(route('pegawai.pengajuan.index')); ?>" method="GET" class="filter-form-pegawai">
                    ...
                    <div class="filter-group-pegawai">
                        ...
                        <select name="status" id="statusInput" class="filter-input-pegawai">
                            ...
                            <option value="menunggu_atasan" <?php echo e(request('status') == 'menunggu_atasan' ? 'selected' : ''); ?>>Menunggu Atasan</option>
                            <option value="ditolak_atasan" <?php echo e(request('status') == 'ditolak_atasan' ? 'selected' : ''); ?>>Ditolak Atasan</option>
                    ...
                    <div class="filter-actions-pegawai">
                        ...
                        <a href="<?php echo e(route('pegawai.pengajuan.index')); ?>" class="btn-reset-pegawai" title="Reset Filter">
            ...
            <div id="tableContainer">
                <?php echo $__env->make('dashboard.pegawai.pengajuan.partials._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </section>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/pegawai/pengajuan/index.blade.php ENDPATH**/ ?>