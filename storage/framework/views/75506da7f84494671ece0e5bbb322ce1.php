<aside class="finance-sidebar" wire:persist="sidebar">
    ...
    <div class="sidebar-header">
        <div class="logo-wrapper">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="sidebar-logo" loading="eager">
        </div>
    </div>
    ...
    <nav class="sidebar-menu" style="position: relative;">
        ...
        <!-- Dashboard -->
        <a href="<?php echo e(route('finance.dashboard')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.dashboard') ? 'active' : ''); ?>">
        ...
        <!-- Persetujuan -->
        <a href="<?php echo e(route('finance.approval.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.approval.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="badge-sidebar badge-approval-finance" 
                ...
                x-init="
                    const updateApprovalCount = () => {
                        fetch('<?php echo e(route('finance.approval.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                            .then(r => r.json())
        ...
        <!-- Pencairan -->
        <a href="<?php echo e(route('finance.disbursement.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.disbursement.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="badge-sidebar badge-disbursement-finance" 
                ...
                x-init="
                    const updateDisbursementCount = () => {
                        fetch('<?php echo e(route('finance.disbursement.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                            .then(r => r.json())
                            .then(data => { count = Number(data.pending_count || 0); })
                            .catch(() => {});
                    };
         ...
         <!-- Notifikasi -->
        <a href="<?php echo e(route('finance.notifikasi')); ?>" wire:navigate.hover class="menu-item notifikasi-menu <?php echo e(request()->routeIs('finance.notifikasi*') ? 'active' : ''); ?>" x-data="{
            unreadCount: 0
        }" x-init="
            const updateNotifCount = () => {
                fetch('<?php echo e(route('finance.notifikasi.count')); ?>', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                    .then(r => r.json())
                    .then(data => {
        ...
        <!-- User -->
        <a href="<?php echo e(route('finance.masterdata.users.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.masterdata.users.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Departemen -->
        <a href="<?php echo e(route('finance.masterdata.departemen.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.masterdata.departemen.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Kategori Biaya -->
        <a href="<?php echo e(route('finance.masterdata.kategori_biaya.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.masterdata.kategori_biaya.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- COA -->
        <a href="<?php echo e(route('finance.masterdata.coa.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.masterdata.coa.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Kas/Bank -->
        <a href="<?php echo e(route('finance.masterdata.kas_bank.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.masterdata.kas_bank.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Jurnal Umum -->
        <a href="<?php echo e(route('finance.report.jurnal_umum')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.report.jurnal_umum') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Buku Besar -->
        <a href="<?php echo e(route('finance.report.buku_besar')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.report.buku_besar') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Rekonsiliasi -->
        <a href="<?php echo e(route('finance.report.reconciliation')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.report.reconciliation') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Arus Kas -->
        <a href="<?php echo e(route('finance.report.laporan_arus_kas')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.report.laporan_arus_kas') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Audit Budget -->
        <a href="<?php echo e(route('finance.report.budget_audit')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.report.budget_audit') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Profil Saya -->
        <a href="<?php echo e(route('finance.profile.index')); ?>" wire:navigate.hover class="menu-item <?php echo e(request()->routeIs('finance.profile.*') ? 'active' : ''); ?>">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/components/finance-sidebar.blade.php ENDPATH**/ ?>