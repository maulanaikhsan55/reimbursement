<?php $__env->startSection('title', 'Kelola Kas/Bank'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Kelola Kas/Bank','subtitle' => 'Daftar rekening kas dan bank yang disinkronkan dari Accurate','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kelola Kas/Bank','subtitle' => 'Daftar rekening kas dan bank yang disinkronkan dari Accurate','showNotification' => true,'showProfile' => true]); ?>
        ...
        <section class="modern-section">
            <div class="section-header">
                ...
                <div class="header-actions">
                    <form action="<?php echo e(route('finance.masterdata.kas_bank.sync')); ?>" method="POST" class="d-inline" id="syncForm">
                        <?php echo csrf_field(); ?>
            ...
            <div class="filter-container">
                <form id="filterForm" action="<?php echo e(route('finance.masterdata.kas_bank.index')); ?>" method="GET" class="filter-form-finance">
                    <div class="filter-group-pegawai">
                        ...
                        <div class="search-group">
                            ...
                            <input type="text" name="search" id="searchInput" value="<?php echo e(request('search')); ?>" class="filter-input-pegawai search-input" placeholder="Nama atau kode kas/bank...">
                        </div>
                    </div>
                    ...
                    <div class="filter-actions-pegawai">
                        ...
                        <a href="<?php echo e(route('finance.masterdata.kas_bank.index')); ?>" class="btn-reset-pegawai" title="Reset Filter">
            ...
            <div id="tableContainer">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kasBanks->isEmpty()): ?>
                ...
                <?php else: ?>
                    <div class="data-table-wrapper">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kasBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td data-label="Kode Perkiraan" class="col-kode">
                                            <code class="code-badge"><?php echo e($item->kode_kas_bank); ?></code>
                                        </td>
                                        <td data-label="Nama Kas / Bank" class="col-nama">
                                            <div style="font-weight: 700; color: #1e293b; font-size: 0.95rem;"><?php echo e($item->nama_kas_bank); ?></div>
                                        </td>
                                        <td data-label="Deskripsi" class="col-catatan">
                                            <div style="font-size: 0.85rem; color: #64748b; max-width: 150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<?php echo e($item->deskripsi); ?>">
                                        ...
                                        <td data-label="Tipe Akun" class="col-tipe">
                                            <span class="meta-badge" style="text-transform: uppercase; background: rgba(66, 93, 135, 0.08); color: #425d87; padding: 4px 10px; border-radius: 6px; font-size: 0.75rem; font-weight: 600;"><?php echo e($item->tipe_akun ?? 'CASH_BANK'); ?></span>
                                        </td>
                                        <td data-label="Saldo" class="col-saldo">
                                            <span class="amount-text"><?php echo e($item->currency_code ?? 'IDR'); ?> <?php echo e(number_format($item->saldo ?? 0, 0, ',', '.')); ?></span>
                                        </td>
                                        <td data-label="Per Tanggal" class="col-as-of">
                                            <span style="font-size: 0.85rem; color: #64748b; font-weight: 500;">
                                                <?php echo e($item->as_of_date ? $item->as_of_date->format('d/m/Y') : '-'); ?>
                                        ...
                                        <td data-label="Sinkron" class="col-sync">
                                            <div style="display: flex; align-items: center; justify-content: center; gap: 6px;">
                                                ...
                                                <span style="font-size: 0.75rem; color: #64748b; font-weight: 500;"><?php echo e($item->last_sync_at ? $item->last_sync_at->diffForHumans() : '-'); ?></span>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="pagination-wrapper">
                        <?php echo e($kasBanks->links('components.pagination')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/finance/masterdata/kas_bank/index.blade.php ENDPATH**/ ?>