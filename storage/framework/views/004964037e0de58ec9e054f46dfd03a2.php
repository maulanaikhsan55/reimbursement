<?php $__env->startSection('title', 'Review Pengajuan - ' . $pengajuan->nomor_pengajuan); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Review Pengajuan','subtitle' => 'Nomor: '.e($pengajuan->nomor_pengajuan).'','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Review Pengajuan','subtitle' => 'Nomor: '.e($pengajuan->nomor_pengajuan).'','showNotification' => true,'showProfile' => true]); ?>
        ...
        <!-- Employee Card -->
            <section class="modern-section" style="padding: 1.5rem;">
                <div class="employee-card-inline">
                    <div class="employee-avatar"><?php echo e(strtoupper(substr($pengajuan->user->name, 0, 1))); ?></div>
                    <div class="employee-info">
                        <h4><?php echo e($pengajuan->user->name); ?></h4>
                        <p><?php echo e($pengajuan->departemen->nama_departemen ?? '-'); ?> • <?php echo e(ucfirst($pengajuan->user->role)); ?> • <?php echo e($pengajuan->user->email); ?></p>
                    </div>
                </div>
            </section>
            ...
            <section class="modern-section">
                <div class="section-header" style="margin-bottom: 1.25rem; padding-bottom: 0; border: none;">
                    ...
                    <a href="<?php echo e(route('atasan.approval.index')); ?>" class="link-back">
                ...
                <div class="timeline">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuan->status->value == 'menunggu_atasan' || $pengajuan->tanggal_disetujui_atasan || $pengajuan->status->value == 'ditolak_atasan' || $pengajuan->isBypassed()): ?>
                        <div class="timeline-item <?php echo e($pengajuan->tanggal_disetujui_atasan || $pengajuan->status->value == 'ditolak_atasan' || $pengajuan->isBypassed() ? 'active' : ''); ?>">
                            <div class="timeline-dot <?php echo e($pengajuan->status->value == 'ditolak_atasan' ? 'bg-danger' : ''); ?>"></div>
                            <div class="timeline-content">
                                <h6 class="mb-1">Review Atasan</h6>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuan->isBypassed()): ?>
                                    <p class="text-success small mb-0">Auto-Approved (Bypass)</p>
                                <?php elseif($pengajuan->tanggal_disetujui_atasan): ?>
                        ...
                        <div class="timeline-item <?php echo e($pengajuan->tanggal_disetujui_finance || $pengajuan->status->value == 'ditolak_finance' || $pengajuan->status->value == 'terkirim_accurate' || $pengajuan->status->value == 'dicairkan' ? 'active' : ''); ?>">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-muted small mb-0">
                                    ...
                                    <?php else: ?> 
                                        Disetujui Finance
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuan->tanggal_disetujui_finance): ?>
                                            - <?php echo e($pengajuan->tanggal_disetujui_finance->format('d M Y')); ?>
...
<?php endif; ?>
                    ...
                    <div class="detail-item full-width">
                        ...
                        <div class="description-box"><?php echo e($pengajuan->deskripsi); ?></div>
                    </div>
                    ...
                    <div class="detail-item full-width">
                        ...
                        <div class="description-box" style="background: #fffbeb; border-left-color: #f59e0b;"><?php echo e($pengajuan->catatan_pegawai); ?></div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.budget-indicator','data' => ['status' => $budgetData,'departmentName' => $pengajuan->departemen->nama_departemen ?? 'Departemen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($budgetData),'departmentName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pengajuan->departemen->nama_departemen ?? 'Departemen')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <section class="modern-section" style="border-color: #3b82f6; box-shadow: 0 10px 15px -3px rgba(59, 130, 246, 0.1);">
                ...
                <div class="action-buttons-simple">
                    ...
                    <button 
                        ...
                        onclick="openRejectModal('<?php echo e(route('atasan.approval.reject', $pengajuan->pengajuan_id)); ?>', 'catatan_atasan')"
                    ...
                    <!-- Approve Form -->
                    <form action="<?php echo e(route('atasan.approval.approve', $pengajuan->pengajuan_id)); ?>" method="POST" style="flex: 1;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/atasan/approval/show.blade.php ENDPATH**/ ?>