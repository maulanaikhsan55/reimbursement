...
<script>
    ...
    function initPegawaiDashboard() {
        ...
        if (statusCtx) {
            ...
            const statusRaw = <?php echo json_encode($statusData); ?>;
            const sData = [
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Dashboard Pegawai','subtitle' => 'Kelola dan pantau semua pengajuan reimbursement Anda','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard Pegawai','subtitle' => 'Kelola dan pantau semua pengajuan reimbursement Anda','showNotification' => true,'showProfile' => true]); ?>
...
<?php endif; ?>
        ...
        <div class="smarter-dashboard-alerts" style="display: flex; flex-direction: column; gap: 1rem;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($overslaCount > 0): ?>
                <div class="sla-alert" style="background: white; border: 1px solid #fecaca; border-radius: 1rem; padding: 1.25rem; box-shadow: 0 4px 20px -5px rgba(239, 68, 68, 0.1); display: flex; align-items: center; gap: 1.25rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0.2rem 0 0 0; color: #b91c1c; font-size: 0.8rem; opacity: 0.8;">Ada <?php echo e($overslaCount); ?> pengajuan Anda yang belum diproses lebih dari 3 hari.</p>
                    </div>
                    <a href="<?php echo e(route('pegawai.pengajuan.index')); ?>" style="margin-left: auto; background: #ef4444; color: white; padding: 0.5rem 1rem; border-radius: 8px; font-size: 0.8rem; font-weight: 700; text-decoration: none; transition: all 0.2s;">Cek Status</a>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="dashboard-main-grid" style="display: grid; grid-template-columns: 1fr 300px; gap: 1rem; align-items: start;">
            ...
            <div class="recent-section" style="background: white; border-radius: 1.25rem; border: 1px solid #f1f5f9; padding: 1rem; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; padding-bottom: 0.5rem; border-bottom: 1px solid #f1f5f9;">
                    ...
                    <a href="<?php echo e(route('pegawai.pengajuan.index')); ?>" style="font-size: 0.75rem; color: #3b82f6; text-decoration: none; font-weight: 700; display: flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: #eff6ff; border-radius: 8px; transition: all 0.2s;">
                        Lihat Semua
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td data-label="Vendor" style="padding: 0.6rem 0.5rem;">
                                            <span style="font-weight: 600; color: #1e293b;"><?php echo e($pengajuan->nama_vendor); ?></span>
                                        </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-badge','data' => ['status' => $pengajuan->status]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pengajuan->status)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                        ...
                                        <td data-label="Aksi" style="text-align: center; padding: 0.6rem 0.5rem;">
                                            <div style="display: flex; gap: 0.4rem; justify-content: center;">
                                                <a href="<?php echo e(route('pegawai.pengajuan.show', $pengajuan->pengajuan_id)); ?>" class="btn-action-icon" style="width: 28px; height: 28px;" title="Lihat detail">
                                                ...
                                                <a href="<?php echo e(route('pegawai.pengajuan.create', ['duplicate_id' => $pengajuan->pengajuan_id])); ?>" class="btn-action-icon" style="width: 28px; height: 28px; background: #f0f7ff; color: #3b82f6;" title="Ajukan lagi (Duplikat)">
            ...
            <div class="quick-actions-minimal">
                ...
                <div class="quick-actions-vertical">
                    <a href="<?php echo e(route('pegawai.pengajuan.create')); ?>" class="modern-action-card quick-card quick-card-primary">
                    ...
                    <a href="<?php echo e(route('pegawai.pengajuan.index')); ?>" class="modern-action-card quick-card quick-card-warning">
                    ...
                    <a href="<?php echo e(route('pegawai.profile.index')); ?>" class="modern-action-card quick-card quick-card-success">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/pegawai/dashboard.blade.php ENDPATH**/ ?>