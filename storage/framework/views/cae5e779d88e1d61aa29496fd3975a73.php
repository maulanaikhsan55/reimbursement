<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuanList->total() === 0 && !request('search') && !request('status') && !request('tanggal_from') && !request('tanggal_to')): ?>
...
<?php endif; ?>
                        ...
                        <td data-label="Aksi" class="col-aksi">
                            <div class="action-buttons-centered">
                                <a href="<?php echo e(route('atasan.pengajuan.show', $pengajuan->pengajuan_id)); ?>" class="btn-action-icon" title="Lihat detail">
                                ...
                                <a href="<?php echo e(route('atasan.pengajuan.create', ['duplicate_id' => $pengajuan->pengajuan_id])); ?>" class="btn-action-icon btn-action-icon-duplicate" title="Ajukan lagi (Duplikat)">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                                </a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($pengajuan->status->value, ['validasi_ai', 'menunggu_finance', 'ditolak_finance'])): ?>
                                <form action="<?php echo e(route('atasan.pengajuan.destroy', $pengajuan->pengajuan_id)); ?>" method="POST" class="inline-action-form">
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/atasan/pengajuan/partials/_table.blade.php ENDPATH**/ ?>