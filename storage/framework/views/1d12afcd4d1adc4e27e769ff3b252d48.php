<?php $__env->startSection('title', 'Profil Saya - Pegawai'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Profil Saya','subtitle' => 'Kelola informasi profil dan pengaturan akun Anda','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Profil Saya','subtitle' => 'Kelola informasi profil dan pengaturan akun Anda','showNotification' => true,'showProfile' => true]); ?>
...
<?php endif; ?>
        ...
        <div class="tabs-container profile-tabs-container">
            ...
            <div class="modern-section profile-modern-section">
                ...
                <form action="<?php echo e(route('pegawai.profile.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <small class="form-error"><?php echo e($message); ?></small>
                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="nomor_telepon" name="nomor_telepon" class="form-control" 
                                   value="<?php echo e($user->nomor_telepon ?? ''); ?>" 
                                   placeholder="Contoh: 081234567890" autocomplete="tel">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nomor_telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_bank" name="nama_bank" class="form-control" 
                                   value="<?php echo e($user->nama_bank ?? ''); ?>" 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nomor_rekening" name="nomor_rekening" class="form-control" 
                                   value="<?php echo e($user->nomor_rekening ?? ''); ?>" 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="form-display"><?php echo e($user->departemen->nama_departemen ?? '-'); ?></div>
                            </div>

                            <div class="form-group">
                                <label>Role</label>
                                <div class="form-display"><?php echo e(ucfirst($user->role)); ?></div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="keamanan" class="tab-content profile-tab-content">
            <div class="modern-section profile-modern-section">
                ...
                <form action="<?php echo e(route('pegawai.profile.password')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', initPegawaiProfileTabs);
    document.addEventListener('livewire:navigated', initPegawaiProfileTabs);
</script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/pegawai/profile.blade.php ENDPATH**/ ?>