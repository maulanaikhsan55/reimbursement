<?php $__env->startSection('title', 'Detail Pengajuan - ' . $pengajuan->nomor_pengajuan); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Detail Pengajuan','subtitle' => 'Review dan kirim pengajuan ke Accurate','showNotification' => true,'showProfile' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Pengajuan','subtitle' => 'Review dan kirim pengajuan ke Accurate','showNotification' => true,'showProfile' => true]); ?>
        ...
        <section class="modern-section">
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?php echo e($pengajuan->tanggal_pengajuan->format('d M Y')); ?></div>
                </div>
                <div class="detail-item">
...
<?php endif; ?>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?php echo e($pengajuan->user->name); ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Departemen</div>
                    <div class="detail-value">
                        <?php echo e($pengajuan->departemen->nama_departemen); ?>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($pengajuan->jenis_transaksi):
                            case ('marketplace'): ?>
                                <span class="badge" style="background: #dbeafe; color: #0284c7;">Marketplace</span>
                                <?php break; ?>
                            <?php case ('transfer_direct'): ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$pengajuan->validasiAi->isEmpty()): ?>
...
<?php endif; ?>
        ...
        <section class="modern-section" style="padding: 1.25rem 1.5rem;">
            ...
            <form action="<?php echo e(route('finance.approval.send-to-accurate', $pengajuan)); ?>" method="POST" class="accurate-form" style="gap: 1rem;">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 0.75rem;">
                    <div class="form-group" style="gap: 0.4rem;">
                        <label for="coa_id" class="form-label" style="margin-bottom: 0; display: flex; align-items: center; gap: 0.5rem; height: 20px;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuan->coa_id): ?>
                                <span class="badge" style="background: #d1fae5; color: #065f46; border: 1px solid #a7f3d0; font-size: 0.65rem; padding: 2px 8px; border-radius: 0.375rem; font-weight: 600; display: inline-flex; align-items: center; gap: 0.25rem;">
                                    ...
                                    Default from <?php echo e($pengajuan->kategori->nama_kategori ?? 'Kategori'); ?>
                        ...
                        <select name="coa_id" id="coa_id" class="form-select" style="padding: 0.6rem 0.875rem; border-radius: 0.75rem; border-color: #e2e8f0;" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($coa->coa_id); ?>" <?php echo e(old('coa_id', $pengajuan->coa_id) == $coa->coa_id ? 'selected' : ''); ?> data-default="<?php echo e($pengajuan->kategori && $pengajuan->kategori->default_coa_id == $coa->coa_id ? 'true' : 'false'); ?>">
                                    <?php echo e($coa->kode_coa); ?> - <?php echo e($coa->nama_coa); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengajuan->kategori && $pengajuan->kategori->default_coa_id == $coa->coa_id): ?>
                                        (Default - <?php echo e($pengajuan->kategori->nama_kategori); ?>)
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
                        <p style="font-size: 0.75rem; color: #6b7280; margin-top: 0.4rem; margin-bottom: 0;">
                            Rekomendasi COA dari kategori <strong><?php echo e($pengajuan->kategori->nama_kategori ?? '-'); ?></strong>. Anda bisa mengubahnya jika diperlukan.
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coaPrediction): ?>
                                <br />
                                <span style="color: #059669; font-weight: 500;">💡 Saran: <?php echo e($coaPrediction['coa_code']); ?> - <?php echo e($coaPrediction['coa_name']); ?> (<?php echo e($coaPrediction['confidence']); ?> confidence)</span>
                                <br />
                                <span style="color: #6b7280; font-size: 0.7rem;"><?php echo e($coaPrediction['reason']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['coa_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-group" style="gap: 0.4rem;">
                        ...
                        <select name="kas_bank_id" id="kas_bank_id" class="form-select" style="padding: 0.6rem 0.875rem; border-radius: 0.75rem; border-color: #e2e8f0;" required onchange="checkRealTimeBalance(this.value)">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kasBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kas->kas_bank_id); ?>" <?php echo e(old('kas_bank_id', $pengajuan->kas_bank_id) == $kas->kas_bank_id ? 'selected' : ''); ?>>
                                    <?php echo e($kas->kode_kas_bank); ?> - <?php echo e($kas->nama_kas_bank); ?>
                        ...
                        <div id="balance-warning" style="display: none; color: #dc2626; font-size: 0.7rem; margin-top: 0.25rem; font-weight: 600;">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'alert-triangle','class' => 'w-3 h-3','style' => 'display: inline; vertical-align: middle; margin-right: 0.25rem;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'alert-triangle','class' => 'w-3 h-3','style' => 'display: inline; vertical-align: middle; margin-right: 0.25rem;']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['kas_bank_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-actions" style="padding-top: 0.75rem; margin-top: 0.75rem; border-top: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center;">
                    <a href="<?php echo e(route('finance.approval.index')); ?>" class="btn-modern btn-modern-secondary" style="padding: 0.5rem 1.25rem; border-radius: 0.75rem;">
                    ...
                    <div class="action-group" style="display: flex; gap: 0.75rem;">
                        <button type="button" class="btn-modern btn-modern-danger" style="padding: 0.5rem 1.25rem; border-radius: 0.75rem;" onclick="openRejectModal('<?php echo e(route('finance.approval.reject', $pengajuan)); ?>', 'catatan_finance')">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 0.5rem;">
        ...
        <section class="modern-section">
            ...
            <div class="detail-grid">
                <div class="detail-item">
                    ...
                    <div class="detail-value text-mono"><?php echo e($pengajuan->coa->kode_coa ?? '-'); ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Nama Akun</div>
                    <div class="detail-value"><?php echo e($pengajuan->coa->nama_coa ?? '-'); ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Sumber Dana (Kas/Bank)</div>
                    <div class="detail-value"><?php echo e($pengajuan->kasBank->nama_kas_bank ?? '-'); ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">ID Transaksi Accurate</div>
                    <div class="detail-value text-mono" style="color: #6366f1; font-weight: 600;"><?php echo e($pengajuan->accurate_transaction_id ?? '-'); ?></div>
                </div>
            </div>
            <div class="form-actions" style="margin-top: 1.5rem; border-top: 1px solid #f1f5f9; padding-top: 1rem;">
                <a href="<?php echo e(url()->previous()); ?>" class="btn-modern btn-modern-secondary">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 16px; height: 16px; margin-right: 0.5rem;">
                        <line x1="19" y1="12" x2="5" y2="12"></line>
                        <polyline points="12 19 5 12 12 5"></polyline>
                    </svg>
...
<script>
    const PENGELUARAN_TOTAL = <?php echo e($pengajuan->nominal); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\reimbursement_ikhsansblm dipush\resources\views/dashboard/finance/approval/show.blade.php ENDPATH**/ ?>